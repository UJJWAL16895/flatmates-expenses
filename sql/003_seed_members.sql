...
INSERT INTO groups (id, name, created_by) VALUES
  ('g0000000-0000-0000-0000-000000000000', 'Flatmates', 'a1111111-1111-1111-1111-111111111111')
...
INSERT INTO group_members (group_id, user_id, joined_at, left_at, invited_by) VALUES
  ('g0000000-0000-0000-0000-000000000000', 'a1111111-1111-1111-1111-111111111111', '2026-02-01', NULL, NULL),
  ('g0000000-0000-0000-0000-000000000000', 'b2222222-2222-2222-2222-222222222222', '2026-02-01', NULL, NULL),
  ('g0000000-0000-0000-0000-000000000000', 'c3333333-3333-3333-3333-333333333333', '2026-02-01', NULL, NULL),
  -- Meera: joined Feb 1, LEFT March 31
  ('g0000000-0000-0000-0000-000000000000', 'd4444444-4444-4444-4444-444444444444', '2026-02-01', '2026-03-31', NULL),
  -- Dev: joined Mar 8 for Goa trip, left Mar 14
  ('g0000000-0000-0000-0000-000000000000', 'e5555555-5555-5555-5555-555555555555', '2026-03-08', '2026-03-14', NULL),
  -- Sam: joined Apr 8 (moved in mid-April)
  ('g0000000-0000-0000-0000-000000000000', 'f6666666-6666-6666-6666-666666666666', '2026-04-08', NULL, NULL)
ON CONFLICT DO NOTHING;
